...
> <mark>**NOTE:** Please visit the [official VPS docs](https://docs.privatecaptcha.com/docs/deployment/vps/) for detailed up-to-date instructions.</mark>
...
Do **not** treat it as a production-ready setup.
